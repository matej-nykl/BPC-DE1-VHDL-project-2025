...
#
# Script generated by Vivado on Wed Apr 23 12:50:41 CEST 2025
...
export RDI_DATADIR="/home/matteo/.var/app/com.github.corna.Vivado/data/xilinx-install/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "xadc_wiz_0.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/matteo/.var/app/com.github.corna.Vivado/data/xilinx-install/Vivado/2024.2/data/xsim"
  fi
